...
dotenv.config(); //Toutes les routes
...
const pokemonRoute = require('../routes/pokemon'); //connect Db
...
app.use(bodyParser.json()); //route server

app.use(cors()); //All routes

app.use('/', indexRoute);
app.use('/pokemons', pokemonRoute); //error 404
